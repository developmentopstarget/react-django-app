...
const Home = () => {
    ...
    return (
        <main className="min-h-[calc(100vh-65px)] bg-gray-100 px-4 py-16 dark:bg-gray-900">
            <div className="mx-auto max-w-5xl space-y-10">
                <section className="text-center">
                    ...
                    <h1 className="mt-3 text-4xl font-extrabold text-gray-900 sm:text-5xl dark:text-white">
                    ...
                    <div className="mt-8 flex flex-wrap justify-center gap-4">
                        {user ? (
                            <>
                                ...
                                <Link
                                    to="/items"
                                    className="rounded-md bg-white px-5 py-3 text-sm font-medium text-gray-900 shadow hover:bg-gray-50 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700"
                                >
                                    Manage Items
                                </Link>
                ...
                <section className="grid gap-6 md:grid-cols-3">
                    {features.map(({ label, description }) => (
                        <div key={label} className="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
